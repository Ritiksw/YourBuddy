...
CREATE INDEX IF NOT EXISTS idx_buddy_relationships_buddy ON buddy_relationships(buddy_id);
CREATE INDEX IF NOT EXISTS idx_buddy_relationships_goal ON buddy_relationships(goal_id);
